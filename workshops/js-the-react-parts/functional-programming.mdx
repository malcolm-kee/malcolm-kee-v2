...
![The graph of f(x) = 2x.](https://res.cloudinary.com/djzsjzasg/image/upload/v1619840447/malcolm-kee/y_2x_jpxiwu.png)
...
![The graph of f(x) = x square - 5.](https://res.cloudinary.com/djzsjzasg/image/upload/v1619840447/malcolm-kee/y_2x2-5_jcvbeq.png)
...
<Details summary="Answer (Click to show)">

It modify `nums` array on line 4.
