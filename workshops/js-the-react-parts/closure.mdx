...
<div id="currying-example" className="mb-8">
  <h2 id="selected-pokemon">Select your Pokemon:</h2>
  <audio id="bulbasaur-sound" src="/audio/bulbasaur.ogg" />
  <audio id="charmander-sound" src="/audio/charmander.ogg" />
  <audio id="squirtle-sound" src="/audio/squirtle.ogg" />
  <div className="space-x-3">
    <button id="bulbasaur" data-sound="bulbasaur-sound">
      {'Bulbasaur'}
    </button>
    <button id="charmander" data-sound="charmander-sound">
      {'Charmander'}
    </button>
    <button id="squirtle" data-sound="squirtle-sound">
      {'Squirtle'}
    </button>
  </div>
</div>
...
<div id="currying-exercise" className="mb-16">
  <h5 className="text-2xl">Currying example</h5>
  <p>I am text</p>
  <div className="space-x-2">
    <button id="size-12" data-color="red">
      Red 12
    </button>
    <button id="size-14" data-color="blue">
      Blue 14
    </button>
    <button id="size-16" data-color="yellow">
      Yellow 16
    </button>
  </div>
</div>
