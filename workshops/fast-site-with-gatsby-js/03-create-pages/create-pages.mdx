...
![Components are main building blocks of a Gatsby site](https://res.cloudinary.com/djzsjzasg/image/upload/v1622712715/malcolm-kee/gatsbyjs-overview-highlight-component_ukvipl.png)
