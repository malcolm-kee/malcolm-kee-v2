...
![Plugins can be used to enhance build process of Gatsby](https://res.cloudinary.com/djzsjzasg/image/upload/v1622712881/malcolm-kee/gatsbyjs-overview-highlight-build_ygnuqd.png)
